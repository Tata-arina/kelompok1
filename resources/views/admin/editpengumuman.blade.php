                ...
                <div class="card-body">   
                    <form action="/updatepengumuman {{ $Pengumuman->id }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="isi_pengumuman" id="isi_pengumuman" cols="30" rows="5"> {{ $Pengumuman->isi_pengumuman}}</textarea>
                        </div>
                        <div class="mb-3">
                            ...
                            <img src="{{ asset('storage/' . $Pengumuman->gambar_pengumuman) }}" class="img-thumbhnail mt-3" width="30%" alt="Foto">
                        </div>
                        <div class="text-end">
